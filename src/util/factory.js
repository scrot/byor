...
const GoogleSheetInput = function () {
  ...
  self.build = function () {
    ...
    if (domainName && queryParams.sheetId.endsWith('csv')) {
      ...
      var bannerText = '<div><h1>CIO Technology Radar</h1><p>brought to you by CIO PBCIB Technology Services</p></div>'
...
function setDocumentTitle () {
  document.title = 'CIO PBCIB Technology Radar'
}
...
function plotLogo (content) {
  content.append('div')
    ...
    .html('<a href="https://www.abnamro.nl/nl/prive/index.html"><img src="/images/tw-logo.png" / ></a>')
}
